  ...
  return(
    <div className="row">
      ...
      <div className="about-col col-md-6 offset-md-3 text-center">
        ...
        <p className="lead">
          We spend an awful lot of time on the internet and most of the time it's searching for information. The goal of bizcard was to create an interface that allows users to query a company's contact info without distractions 🚀. What was that take-out's phone number again?
        </p>
        <p className="lead">
